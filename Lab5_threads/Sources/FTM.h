...
/*!
 *  @defgroup FlexTimer_module FlexTimer module documentation
 *  @{
*/
/* MODULE FlexTimer */
...
/** Enumerated Timer Function Masks */
typedef enum
{
...
/** Enumerated Output Compare Masks */
typedef enum
{
...
/** Enumerated Input Capture Masks */
typedef enum
{
  TIMER_INPUT_OFF,
  TIMER_INPUT_RISING,
...
/** Stores a semaphore for each FTM Channel Output Compare event */
extern OS_ECB* FTM_ChannelOutputEventSemaphores[];
