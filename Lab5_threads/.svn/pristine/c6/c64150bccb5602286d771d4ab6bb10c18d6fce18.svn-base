...
/*!
 *  @defgroup Flash_module Flash module documentation
 *  @{
*/
/* MODULE Flash */
...
/** Masks to check if Flash data is erased for various data sizes. */
#define FLASH_ERASED_PHRASE 	0xffffffffffffffff
#define FLASH_ERASED_WORD 	0xffffffff
#define FLASH_ERASED_HWORD 	0xffff
...
/*! @brief A function to conveniently read a byte of data from any given Flash address.
 *
 *  @param address wanting to be read from.
 *
 *  @param data is a pointer to read the data from Flash into, returning it to the caller.
 *
 *  @return bool - TRUE if the given address was in the valid range of Flash data we are using.
 */
bool Flash_ReadByte(volatile uint8_t* const address, uint8_t *data);
